...
def get_phrases():
    return [
        "Gorgeous blue butterfly front view, with a yellow background",
        "A side profile of a butterfly landing on top of a beautiful flower, monarch butterfly with grassy background",
        "A stylized bee with a honeycomb background high quality"
    ]

def run_program_concurrently(times=3):
    phrases = get_phrases()
    shuffle(phrases)
